import { p as proxyCustomElement, H } from './p-b4d3b526.js';
...
const TimerLogin = /*@__PURE__*/ proxyCustomElement(class TimerLogin extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return RfTimerLoginStyle0; }
}, [1, "rf-timer-login", {
        "emailInputBind": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["rf-timer-login"];
    components.forEach(tagName => { switch (tagName) {
        case "rf-timer-login":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TimerLogin);
            }
            break;
    } });
}
...
const RfTimerLogin = TimerLogin;
const defineCustomElement = defineCustomElement$1;

export { RfTimerLogin, defineCustomElement };

//# sourceMappingURL=rf-timer-login.js.map